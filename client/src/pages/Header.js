                                    ...
                                    <div className="dropdown profile-1 d-flex">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            <Link className="dropdown-item" to="/profile">
                                                <i className="dropdown-icon mdi mdi-account-outline"></i> {authState.username}
                                            </Link>
                                            <Link className="dropdown-item" to={`/edit_profile/${authState.id}`}>
                                            ...
                                            <Link className="dropdown-item" href="login.html">
                                                <i className="dropdown-icon mdi  mdi-logout-variant"></i><button onClick={logout}>Logout</button>
